...
urlpatterns = [
    ...
    # path('api/v1/', include(router.urls))  # we use preinstalled routers in DRF http://127.0.0.1:8000/men/api/v1
    # path('api/v1/men', MenViewSet.as_view({'get': 'list'})),
    # path('api/v1/men', MenViewSet.as_view({'get': 'list'})),
    # path('api/v1/men/<int:pk>/', MenViewSet.as_view({'put': 'update'})),
